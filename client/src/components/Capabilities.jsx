    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            <div className="p-3 bg-ds-bg border-2 border-ds-border select-none text-ds-blurple">
              <Brain className="w-8 h-8" />
            </div>
            <div className="flex-1">
              <h3 className="font-display text-xl font-black text-ds-text uppercase mb-2">
                Context Retention
              </h3>
          ...
          <SpotlightCard
            className="bento-card-animate custom-card flex flex-col gap-4 items-start"
            spotlightColor="rgba(255, 51, 51, 0.15)"
          >
            <div className="p-3 bg-ds-bg border-2 border-ds-border select-none text-ds-red">
          ...
          >
            <div className="p-3 bg-ds-bg border-2 border-ds-border select-none text-ds-yellow">
          ...
          >
            <div className="p-3 bg-ds-bg border-2 border-ds-border select-none text-ds-fuchsia">
