  ...
  return (
    <div className="min-h-screen bg-ds-bg text-ds-text font-mono flex flex-col">
      <SEO
        ...
        description="Rules, guidelines, and permitted usage policies for Tars Bot."
      />
        ...
        <div className="space-y-10 leading-relaxed text-base">
          <section className="custom-card border-2 border-ds-border p-6 bg-ds-card/45 shadow-[4px_4px_0px_var(--border-color)]">
            ...
            <p className="text-ds-muted">
              ...
              boundaries set by the Discord Terms of Service. If you do not
              accept these policies, do not invite or execute the bot.
            </p>
          </section>
          ...
          <section className="custom-card border-2 border-ds-border p-6 bg-ds-card/45 shadow-[4px_4px_0px_var(--border-color)]">
            ...
            <ul className="list-none pl-4 space-y-2 text-sm">
              <li className="flex items-center gap-2.5">
                <AlertTriangle
                  className="w-4 h-4 text-ds-red shrink-0"
                  aria-hidden="true"
                />
                <span>
                  Use the bot to scrape member IDs or execute cyber harassment
                </span>
              </li>
              <li className="flex items-center gap-2.5">
                <AlertTriangle
              ...
              <li className="flex items-center gap-2.5">
                ...
                />
                <span>
                  Attempt to decompile or inject malicious code into the bot
                  framework
                </span>
              </li>
            </ul>
          ...
          <section className="custom-card border-2 border-ds-border p-6 bg-ds-card/45 shadow-[4px_4px_0px_var(--border-color)]">
            ...
            <p className="text-ds-muted">
              TARS' responses are AI-synthesized and designed with a high level
              of sarcasm. The bot operators accept absolutely zero liability for
              any mental strain, severe roasts, or misunderstandings caused by
              TARS' automated sarcasm index. Use under server moderation
              oversight.
            </p>
          </section>
          ...
          <section className="custom-card border-2 border-ds-border p-6 bg-ds-card/45 shadow-[4px_4px_0px_var(--border-color)]">
            ...
            <p className="text-ds-muted">
              We reserve the right to ban specific servers or individual user
              IDs found in violation of these terms without prior notice.
            </p>
          </section>
